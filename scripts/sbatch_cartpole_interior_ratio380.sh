...
#SBATCH --array=0-63
#SBATCH --output=logs/cp_i380_%A_%a.out
...
CONFIGS=(
  "1.710   0.450"     # alpha = 3.80*beta throughout
  "2.413   0.635"     # Dhruv's low  -- measured here for the first time
  "3.317   0.873"     # Dhruv's med
  "4.560   1.200"
  "5.428   1.429"     # Dhruv's high
  "6.840   1.800"
  "9.120   2.400"
  "12.160  3.200"     # far enough to find the collapse, if there is one
)
NSHARDS=8
